...
star_A = Body(
    pos=[-7.5e10, 0.0, 0.0], vel=[0.0, -15000.0, 0.0], mass=1.989e30, radius=6.9634e8
)
star_B = Body(
    pos=[7.5e10, 0.0, 0.0], vel=[0.0, 15000.0, 0.0], mass=1.989e30, radius=6.9634e8
)
